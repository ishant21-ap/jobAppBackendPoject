    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item text-white"><a class="nav-link text-light" href="home">Home</a>
                </li>
                <li class="nav-item text-white"><a class="nav-link text-light" href="viewalljobs">All
                    Jobs</a></li>

                <li class="nav-item "><a class="nav-link text-white"
                                        href="https://www.linkedin.com/in/ishant-rathi-88807b261/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
